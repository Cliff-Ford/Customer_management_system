...
<%@ taglib prefix="cliff" uri="http://cliff.com/common/"%>
<%
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="<%=basePath%>customerManager/list">BOOT客户管理系统 v2.0</a>
	</div>
	<!-- 导航栏右侧图标部分 -->
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
				    <a href="${pageContext.request.contextPath }/customerManager/list" class="active">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
				      action="${pageContext.request.contextPath }/customerManager/list">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="col-md-12 text-right">
						<cliff:page url="${pageContext.request.contextPath }/customerManager/list" />
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
...
//清空新建客户窗口中的数据
	...
	$.post("<%=basePath%>customerManager/create",
	...
	function editCustomer(id) {
	    $.ajax({
	        type:"get",
	        url:"<%=basePath%>customerManager/getCustomerById",
	        data:{"id":id},
	...
	function updateCustomer() {
		$.post("<%=basePath%>customerManager/update",$("#edit_customer_form").serialize(),function(data){
			if(data =="OK"){
				alert("客户信息更新成功！");
				window.location.reload();
			}else{
	...
	$.post("<%=basePath%>customerManager/deleteById",{"id":id},
	function(data){
	            if(data =="OK"){
	                alert("客户删除成功！");
	                window.location.reload();
